  ...
  <body>
    <header class="header-area overlay">
      ...
      <div class="banner">
       ...
       <a href="http://127.0.0.1:8000/stushow" class="button button-primary">Check Jobs</a><br>
       <a href="http://127.0.0.1:8000/appview" class="button button-primary">View  Applications</a><br>
