  ...
  <body>
    <header class="header-area overlay">
      ...
      <div class="banner">
       ...
       <a href="http://127.0.0.1:8000/assignments" class="button button-primary">Add Assignments</a><br>
       <a href="http://127.0.0.1:8000/assignmentshow" class="button button-primary">View Posted</a><br>
       <a href="http://127.0.0.1:8000/submissions" class="button button-primary">Check Submissions</a><br>
          </div>
      </div>
  </header>
