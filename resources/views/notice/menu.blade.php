  ...
  <body>
    <header class="header-area overlay">
      ...
      <div class="banner">
       ...
       <a href="http://127.0.0.1:8000/notice" class="button button-primary">Add Notice</a><br>
       <a href="http://127.0.0.1:8000/noticeshow" class="button button-primary">View Notice</a><br>
